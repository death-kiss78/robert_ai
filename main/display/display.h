...
public:
    ...
    virtual void ShowNotification(const char* notification, int duration_ms = 5000);
    virtual void ShowNotification(const std::string& notification, int duration_ms = 5000);
